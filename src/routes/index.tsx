...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "CronoGraf — Your Personal Ancestry Tree" },
      { name: "description", content: "Build, edit, and save your own ancestry tree." },
    ],
  }),
});
    ...
    <div className="mx-auto max-w-4xl px-4 py-20">
      <div className="text-center">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          Map your family. Drag nodes — relations update by generation. Save it to your account.
        </p>
        <div className="mt-8 flex justify-center gap-3">
          <Link to="/ancestry" className="inline-flex items-center gap-2 rounded-md bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground hover:bg-primary/90">
            <TreePine className="h-4 w-4" /> Open Ancestry Tree
          </Link>
      ...
      <div className="mt-16 grid gap-4 sm:grid-cols-3">
        {[
          { icon: Users, title: "Personal", desc: "Each account has its own private tree." },
          { icon: TreePine, title: "Auto labels", desc: "Move a person above the root — they become a parent, grandparent…" },
          { icon: LogIn, title: "Saved", desc: "One click to persist your changes." },
        ].map((f) => (
